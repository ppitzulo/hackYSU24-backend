...
def capture_and_send():
    ...
    save_interval = 1.1  # Interval between predictions
    ...
    # ), thickness=2, circle_radius=2),
        ...
        # Emit the frame and prediction
        # print("Emitting frame and prediction" + str(encoded_image))
        socketio.emit('frame', {'image': encoded_image, 'prediction': latest_prediction})
...
def handle_my_custom_event(data):
    print("Emitting data to client:", data)
    # Request acknowledgment from the client
    emit('frame', {'data': data}, callback=acknowledgment_received)

def acknowledgment_received():
    print("Client has acknowledged receipt of the message.")
